...
#### 채권
- (발행자 관점 : 재무상태표에 회사채 반영) 만기에 100,000원을 주고 이자율이 10%, 3년짜리 회사채를 발행할 경우, 실제로 그 회사채를 사는 사람은 102,531원을 주고 살 수도 있고(프리미엄 발행), 97,556원을 주고 살 수도 있음(디스카운트 발행) 이때 프리미엄 발행은 이자를 덜 줘도 된다는 뜻으로, 102,531원을 주고 산 경우 이자율 즉 수익률이 9%만 되어도 된다는 뜻. 이때는 대변 차변에 일단 102,531원을 쓰고(차변은 부채에), 첫해에는 이자를 9,228원만 주면 되는데 실제로는 10,000원을 주니 일단 부채에서 772원을 빼고(그러면 부채는 101,759원) RE에서 나머지 9,228원을 빼면 됨. 그 다음 해에는 원래는 101,759원의 9%인 9,158원만 주면 되는데 실제로는 10,000원을 주니 차액인 842원을 부채에서 빼고(남은 부채 100,917원) 9158원은 RE에서 빼면 됨. 그리고 마지막 해에는 100,917의 9%에 원금까지 주면 되는데 다 합치면 딱 110,000원 나옴.

- (소유자 관점) 셋으로 나눔. Held for Trading(HFT), Available for Sale(AFS), Held to Maturity(HTM). 여기서 HTM은 발행자처럼 회계처리가 간단. 발행자와 회계처리 원리가 같음(자산과 부채에 반영). HFT는 판매가능성이 있으므로 공정가치를 평가하고, 당기손익에 반영(I/S)하고 RE에 반영. AFS도 판매가치가 있으니 공정가치를 평가하지만, 자본의 AOCI에 반영(아직 손익이 아니므로 손익계산서에도 반영 안함). 

- (유효이자율) 발행비용은 유효이자에 반영해서 천천히 비용처리됨.
